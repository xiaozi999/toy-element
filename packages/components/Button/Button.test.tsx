...
describe("ButtonGroup.vue", () => {
  test("basic button group", async () => {
    const wrapper = mount(() => h(ButtonGroup, {}, [
      h(Button, {}, "button 1"),
      h(Button, {}, "button 2")
    ]));
  ...
  test("button group size", () => {
    const sizes = ["large", "default", "small"];
    sizes.forEach((size) => {
      const wrapper = mount(() => h(ButtonGroup, { size: size as any }, [
        h(Button, {}, "button 1"),
        h(Button, {}, "button 2")
      ]));
  ...
  test("button group type", () => {
    const types = ["primary", "success", "warning", "danger", "info"];
    types.forEach((type) => {
      const wrapper = mount(() => h(ButtonGroup, { type: type as any }, [
        h(Button, {}, "button 1"),
        h(Button, {}, "button 2")
      ]));
  ...
  test("button group disabled", () => {
    const wrapper = mount(() => h(ButtonGroup, { disabled: true }, [
      h(Button, {}, "button 1"),
      h(Button, {}, "button 2")
    ]));
